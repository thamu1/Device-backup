...
def report(recon_date:int, off:int,mode:str, property_id:str, credentials_path:str, hostnames:list , dimensions: List[str], metrics: List[Metric], row_limit:int=10 ,quota_usage:bool=False):
    ...
    st_date = str(date.today() - timedelta(days=11))
    en_date = str(date.today() - timedelta(days=11))
                    ...
                    dimension_filter=FilterExpression(
                        and_group=FilterExpressionList(
                            expressions=[
                                ...
                                FilterExpression(
                                    filter=Filter(field_name="sessionSource", in_list_filter = Filter.InListFilter(values = sesssionli, case_sensitive = False)),
                                ),
                            ]
                        ),
                    ), 
...
def get_report(recon_backtrace:int, hdl_staging_loc:str, mode:str, is_group:list):
    ...
    if(mode == "overall"):
        ...
        hostName = [
                ...
                # 'www.wideopenpets.com',
                # 'www.wideopencountry.com',
                # 'cc.bingj.com', 'cdn0.wideopencountry.com', 'cdn0.wideopenpets.com', 'webcache.googleusercontent.com',
                # 'vm-lamp22', 's3.amazonaws.com', 'cdn0.wideopenpets.com',
            ]
...
get_report(recon_backtrace=11,hdl_staging_loc="D:/PCH/PCH Dev Team/Prashant/GA4 Wom/logcheck/",
           mode="major",is_group=[])
